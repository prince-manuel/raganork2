...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~3b35a88c394bbfc7f1e3e637b5cf1e32:5247777765493436697a343d',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "~𓊈𒆜『✞ ꪑꪖ᥊ﺃꪑꪮꪀ ᥇ꪮꪻ✞』𒆜𓊉",
    BOT_NAME: process.env.BOT_NAME || '𓊈𒆜『✞ ꪑꪖ᥊ﺃꪑꪮꪀ ᥇ꪮꪻ✞』𒆜𓊉',
